...
var section = document.querySelector("section");
		...
		var requestURL = 'https://raw.githubusercontent.com/GoonNinja/JS-JSON-Lesson1/main/js/i-scream.json';
		...
		function topFlavors(jsonObj){
			...
			for (var i = 0; i < topFlavors.length; i++) {
				...
				img.setAttribute('src', 'https://raw.githubusercontent.com/GoonNinja/JS-JSON-Lesson1/main/images/' + topFlavors[i].image);
